...
function setup() {
 ...
 // stick = new Stick(450, 700, 10, 150, PI);
  ...
  tempBall = new Player2Ball(100, 100, 50);
...
function detectCollision(hole, ball){
  ...
  if(hole.body.position.x - ball.body.position.x <hole.body.radius + ball.body.radius &&  
   ball.body.position.x  - hole.body.position.x <hole.body.radius + ball.body.radius &&
   hole.body.position.y - ball.body.position.y <hole.body.radius + ball.body.radius &&  
   ball.body.position.y  - hole.body.position.y <hole.body.radius + ball.body.radius){
